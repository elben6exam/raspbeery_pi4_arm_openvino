...
#checkSrcTree $OPENCV_HOME https://hub.fastgit.xyz/opencv/opencv.git 4.x
#checkSrcTree $OPENCV_EXTRA https://hub.fastgit.xyz/opencv/opencv_contrib.git 4.x
#checkSrcTree $OPENVINO_HOME https://hub.fastgit.xyz/elben6exam/openvino.git master
